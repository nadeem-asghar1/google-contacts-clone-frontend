...
const FavoriteContactTile = ({ id, name, phone, color, handleFavorites, is_favorite, handleShowContact }) => {
          ...
          <ListItemButton sx={{ padding: '5px' }} onClick={handleShowContact}>
              <Grid container>
                <Grid item xs={0.6} className='list-tile-item'>
                  <ListItemAvatar>
                    <Avatar sx={{ bgcolor: color }}>{name.charAt(0)}</Avatar>
                  </ListItemAvatar>
                </Grid>
...
export default FavoriteContactTile;
